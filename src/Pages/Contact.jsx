...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Updated with your professional email from your CV
      const formSubmitUrl = 'https://formsubmit.co/ra6hf.6@gmail.com'; 
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      ...
      <div
        ...
        id="Contact"
      >
        <div className="container px-[1%] grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12" >
          <div
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  I'm open to discussing data science, web development, or AI opportunities.
                </p>
              </div>
