  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Hands-on projects built during my CS journey",
    ...
    },
    {
      ...
      label: "Certificates",
      description: "Technical certifications and achievements",
      animation: "fade-up",
    },
    {
      icon: Globe,
      ...
      description: "Freshly graduated from KKU",
      animation: "fade-left",
    },
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
       Computer Science graduate from King Khalid University with a strong academic record 
       (CGPA: 4.21/5 ), specialized in Intelligent 
Systems. Interested in building a career in Data Analysis and Data Science. Strong foundation in data analysis, databases, and front
end development.
                  </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
             <a href="/Rahaf-CV.pdf" download="Rahaf_AlWadai_CV" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
