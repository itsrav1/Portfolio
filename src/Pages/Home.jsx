...
import { Github, Linkedin, Mail, ExternalLink, Twitter, Sparkles } from "lucide-react"
import AOS from 'aos'
...
const WORDS = ["Data Analyst & AI Enthusiast", "Frontend Developer"];
const TECH_STACK = ["Python", "SQL", "React", "Power BI", "Machine Learning"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/itsrav1", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://linkedin.com/in/rahaf-alwadai-929601250", label: "LinkedIn Profile" },
  { icon: Twitter, link: "https://x.com/itsrav__", label: "Twitter Profile" }
];
...
`}</script>
  ...
  <CTAButton href="/Portfolio/#Portfolio" text="Projects" icon={ExternalLink}/>
